...
- [**Tmux**](https://github.com/tmux/tmux) — terminal multiplexing and session management
...
- [Starship Prompt](#starship-prompt--pastel-powerline)
- [Tmux](#tmux)
...
- Using theme from [gpakosz/.tmux](https://github.com/gpakosz/.tmux)
